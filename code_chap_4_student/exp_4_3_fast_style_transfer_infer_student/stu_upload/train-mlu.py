...
if __name__ == '__main__':
    ...
    s1, s2, s3, s4 = net(mlu_image_style)
    # _____________________________________________
    ...
    while j <= epochs:
        for i, image in enumerate(data_loader):
            ...
            if i % 10 == 0:
                ...
                concatenated_image = torch.cat((mlu_image_g, mlu_image_c), dim=3)
                save_image(concatenated_image, './out/train_mlu/' + str(i) + '.png', )
        j += 1
